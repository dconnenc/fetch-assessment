...
//straightforward. I thought about placing the aysnc functions
//in their own /functions folder, but opted not to because the
//project is small enough. 

function App() {

  //state
  const [formState, setFormState] = useState(null);
  const [checklistVis, setChecklistVis] = useState('true');
  ...
  //GETs data for locations and occupations select, triggered by useEffect
  ...
  //POSTs data collected from user
        ...
        <form className="window "
          ...
          <h1 className="lato bolded">FUN!</h1>
              ...
              <input  type="password"
                      ...
                      id="password"
                      alt="Password: Must contain at least one number and at least 6 or more characters"
                      onFocus={()=>{setChecklistVis(true)}}
                      onBlur={()=>{setChecklistVis(false)}}
                      required />
              {checklistVis == true ?
                <PasswordChecklist
                      className={'lato message'}  
                      ...
                      onChange={(isValid) => {}}
                      message={{
                        minLength:"Must have atleast 6 characters",
